 ...
 */
final class Version20260222141832 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quiz_attempt DROP FOREIGN KEY `FK_57F349F4853CD175`');
        $this->addSql('ALTER TABLE quiz_attempt DROP FOREIGN KEY `FK_57F349F4A76ED395`');
        $this->addSql('DROP INDEX idx_57f349f4853cd175 ON quiz_attempt');
        $this->addSql('CREATE INDEX IDX_AB6AFC6853CD175 ON quiz_attempt (quiz_id)');
        $this->addSql('DROP INDEX idx_57f349f4a76ed395 ON quiz_attempt');
        $this->addSql('CREATE INDEX IDX_AB6AFC6A76ED395 ON quiz_attempt (user_id)');
        $this->addSql('ALTER TABLE quiz_attempt ADD CONSTRAINT `FK_57F349F4853CD175` FOREIGN KEY (quiz_id) REFERENCES quiz (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE quiz_attempt ADD CONSTRAINT `FK_57F349F4A76ED395` FOREIGN KEY (user_id) REFERENCES utilisateur (id) ON DELETE SET NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_57F349F4A76ED395 ON quiz_attempt (user_id)');
        $this->addSql('DROP INDEX idx_ab6afc6853cd175 ON quiz_attempt');
        $this->addSql('CREATE INDEX IDX_57F349F4853CD175 ON quiz_attempt (quiz_id)');
