    ...
    public function new(Request $request, UserPasswordHasherInterface $passwordHasher): Response
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($user instanceof ResponsableParapharmacie) {
                $parapharmacieId = $data->get('parapharmacieId') ? (int) $data->get('parapharmacieId') : null;
                if ($parapharmacieId !== null && $parapharmacieId > 0) {
                    $parapharmacie = $this->em->getRepository(Parapharmacie::class)->find($parapharmacieId);
