...
class GoogleController extends AbstractController
{
    ...
    public function __construct(
        ...
        #[Autowire('%env(default::OAUTH_GOOGLE_REDIRECT_URI)%')] string $oauthGoogleRedirectUri = ''
    )
    {
        $this->entityManager = $entityManager;
        $this->tokenStorage = $tokenStorage;
        $this->eventDispatcher = $eventDispatcher;
        $this->oauthGoogleRedirectUri = trim($oauthGoogleRedirectUri);
    }
    ...
    {
        $options = [];
        if ($this->oauthGoogleRedirectUri !== '') {
            $options['redirect_uri'] = $this->oauthGoogleRedirectUri;
        }
